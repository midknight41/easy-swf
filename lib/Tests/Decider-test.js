...
var testGroup2 = {
    ...
    "Can call getActivityState with good params": function (test) {
        var t = basicDCSetup();
    ...
    "Throws an error when calling getActivityState with bad params": function (test) {
        var t = basicDCSetup();
    ...
    "Throws an error when calling getActivityState with bad config": function (test) {
        var t = basicDCSetup();
    ...
    "add tests for getActivityState when no matching event data exists": function (test) {
        var t = basicDCSetup();
