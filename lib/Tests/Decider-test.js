...
var testGroup2 = {
    ...
    "add tests for getActivityState with good params": function (test) {
        var t = basicDCSetup();
    ...
    "add tests for getActivityState with bad params": function (test) {
        var t = basicDCSetup();
    ...
    "add tests for getActivityState with bad config": function (test) {
        var t = basicDCSetup();
