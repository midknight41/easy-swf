...
var testGroup = {
  ...
  "AWS config doesn't throw an error if process.env is correctly set up and the passed config doesn't contain any credentials": function (test: nodeunit.Test): void {
  ...
  "AWS config doesn't throw an error if credentials are passed in": function (test: nodeunit.Test): void {
