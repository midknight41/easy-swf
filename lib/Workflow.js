...
var WorkflowClient = (function () {
    ...
    WorkflowClient.prototype.validateConfig = function (awsConfig) {
        ...
        if (!process.env.AWS_ACCESS_KEY_ID)
            throw new errors.InvalidArgumentError("accessKeyId not found in process.env.AWS_ACCESS_KEY_ID");
        if (!process.env.AWS_SECRET_ACCESS_KEY)
            throw new errors.InvalidArgumentError("secretAccessKey not found in process.env.AWS_SECRET_ACCESS_KEY");
        if (!process.env.AWS_REGION)
            throw new errors.InvalidArgumentError("region not found in process.env.AWS_REGION");
    };
